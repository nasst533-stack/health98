...
export function InbodyTab({ profileId, goal, isMaster, profile }) {
    ...
    return React.createElement("div", { className: "inbody-tab" }, loadError &&
        ...
        })(), React.createElement("h2", null, "체형 정보"), React.createElement("div", { className: "body-info-row" }, React.createElement("button", { type: "button", className: "chip-btn" + (genderDraft === "male" ? " active" : ""), onClick: () => setGenderDraft("male") }, "남"), React.createElement("button", { type: "button", className: "chip-btn" + (genderDraft === "female" ? " active" : ""), onClick: () => setGenderDraft("female") }, "여"), React.createElement("input", {
        type: "number",
        placeholder: "나이",
        value: ageDraft,
        ...
        style: { marginTop: 8 },
    }), React.createElement("button", { type: "button", className: "btn-secondary", onClick: saveBodyInfo, disabled: !heightDraft }, bodyInfoSaved ? "저장됨 ✓" : "체형 정보 저장"), !hasBodyInfo &&
        React.createElement("p", { className: "muted", style: { marginTop: 6 } }, "성별과 키를 저장하면 아래에 실제 인바디처럼 I/C/D 체형 분석이 나와요."), bodyType &&
        React.createElement("div", { className: "bodytype-card" }, React.createElement("div", { className: "bodytype-header" }, React.createElement("div", { className: "bodytype-badge" }, bodyType.type || "-"), React.createElement("div", null, React.createElement("div", { className: "bodytype-title" }, bodyType.title || "골격근량·체지방률을 모두 입력하면 유형이 나와요"), React.createElement("div", { className: "bodytype-desc" }, bodyType.desc || `표준체중 약 ${bodyType.stdWeight}kg 기준으로 계산해요.`))), bodyType.bars.map((b) => React.createElement("div", { className: "bodytype-bar-row", key: b.label }, React.createElement("div", { className: "bodytype-bar-label" }, React.createElement("span", null, b.label), React.createElement("span", null, b.value != null ? `${b.value}${b.unit} · ${b.pct}%` : "미입력")), React.createElement("div", { className: "bodytype-bar-track" }, React.createElement("div", { className: "bodytype-bar-mark", style: { left: "66.7%" } }), b.pct != null &&
