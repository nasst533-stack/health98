...
export function InbodyTab({ profileId, goal, isMaster, profile }) {
  ...
  const weightProgress =
    latest && profile && profile.goalTargetWeight != null && profile.goalStartWeight != null
  ...
  function fetchAiTip() {
    ...
    const prompt =
      "당신은 웨이트 트레이닝/다이어트 코치입니다. 운동, 식단, 체성분(인바디)과 관련 없는 질문에는 답변하지 말고 정중히 거절하세요. " +
  ...
  function fetchWeeklyCheck() {
    ...
    setWeeklyError(null);
    const prompt =
      "당신은 웨이트 트레이닝/다이어트 코치입니다. 아래는 사용자의 최근 7일 운동·식단 데이터와 가장 최신 인바디 기록입니다. " +
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      { className: "goal-hero-card" },
      React.createElement("div", { className: "goal-hero-title" }, "목표 달성률"),
      !latest &&
        React.createElement("div", { className: "goal-hero-sub" }, "인바디 기록을 먼저 입력하면 목표 달성률을 볼 수 있어요."),
      latest &&
        weightProgress == null &&
        muscleProgress == null &&
        React.createElement(
          "div",
          { className: "goal-hero-sub" },
          "목표 체중이나 목표 골격근량을 설정하면, 지금까지 얼마나 왔는지 퍼센트로 보여줘요."
        ),
      (weightProgress != null || muscleProgress != null) &&
        React.createElement(
          "div",
          { className: "ring-row" },
          weightProgress != null &&
      ...
      latest &&
        React.createElement(
          ...
          showGoalTargetForm ? "닫기" : "목표 체중 / 골격근량 설정"
        ),
      showGoalTargetForm &&
        React.createElement(
          "div",
          { className: "goal-target-form" },
          React.createElement("label", null, "목표 체중 (kg, 선택)"),
          React.createElement("input", {
            type: "number",
            step: "0.1",
          ...
          React.createElement("label", null, "목표 골격근량 (kg, 선택)"),
          React.createElement("input", {
            type: "number",
            step: "0.1",
          ...
          React.createElement("button", { type: "button", className: "btn-primary", onClick: saveGoalTargets }, "목표 저장")
        )
    ),
    ...
    React.createElement(
      "div",
      { className: "rec-card" },
      React.createElement("h3", null, "이번 주 체크"),
      !weeklyReport &&
        React.createElement(
          "p",
          { className: "muted", style: { margin: "0 0 10px", fontSize: "13px", lineHeight: 1.5 } },
          "운동 볼륨·섭취 칼로리·탄단지 비율과 최신 인바디 수치를 한 번에 묶어서, 이번 한 주가 어땠는지 AI가 종합 피드백을 줘요."
        ),
      weeklyReport &&
        React.createElement(
          "p",
          { className: "muted", style: { margin: "0 0 10px", fontSize: "13px", lineHeight: 1.6, whiteSpace: "pre-wrap" } },
          weeklyReport
        ),
      !weeklyReport &&
        React.createElement(
          "button",
          { type: "button", className: "btn-secondary", disabled: weeklyLoading, onClick: fetchWeeklyCheck },
          weeklyLoading ? "체크하는 중..." : "체크"
        ),
      weeklyReport &&
        React.createElement(
          "button",
      ...
      weeklyError && React.createElement("p", { style: { color: "var(--danger)", fontSize: "12px", marginTop: 8, marginBottom: 0 } }, weeklyError)
    ),

    React.createElement(
      "div",
      { className: "rec-card" },
      React.createElement("h3", null, aiTip ? "AI 답변" : rec.title),
      React.createElement(
        "p",
      ...
      !aiTip &&
        React.createElement(
          ...
          React.createElement(
            ...
            aiLoading ? "AI 답변 요청 중..." : "AI에게 물어보기 (Gemini)"
          )
        ),
      aiTip &&
        React.createElement(
              ...
              !editingKey &&
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    hasSavedKey ? "Gemini API 키: 설정됨" : "Gemini API 키: 설정 안 됨"
                  ),
                  React.createElement(
                    "button",
                    { type: "button", className: "btn-secondary", style: { fontSize: 12, padding: "4px 10px" }, onClick: openKeyEditor },
                    "API 키 수정"
                  )
                ),
              editingKey &&
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      "button",
                      { type: "button", className: "btn-primary", style: { fontSize: 12, padding: "4px 10px" }, onClick: saveKeyDraft },
                      "저장"
                    ),
                    React.createElement(
                      "button",
                      { type: "button", className: "btn-secondary", style: { fontSize: 12, padding: "4px 10px" }, onClick: () => setEditingKey(false) },
                      "취소"
                    ),
                    hasSavedKey &&
                      React.createElement(
                        "button",
                        { type: "button", className: "btn-secondary", style: { fontSize: 12, padding: "4px 10px" }, onClick: clearKey },
                        "키 해제"
                      )
                  )
                )
