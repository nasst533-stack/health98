...
function EditLogModal({ log, onClose, onSave }) {
  ...
  const [distance, setDistance] = useState(
    isCardio && log.distanceKm != null ? String(log.distanceKm) : ""
  );
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("h2", null, `${log.exerciseName} 수정`),
      ...
      isCardio
        ? React.createElement(
            React.Fragment,
            null,
            React.createElement("label", null, "시간 (분)"),
            React.createElement("input", {
              type: "number",
              min: 0,
              value: duration,
            ...
            React.createElement("label", null, "거리 (km, 선택)"),
            React.createElement("input", {
              type: "number",
              step: "0.01",
              value: distance,
            ...
            React.createElement("label", null, "경사 (%, 선택)"),
            React.createElement("input", {
              type: "number",
              step: "0.1",
              value: incline,
            ...
            React.createElement("label", null, "칼로리 (kcal, 선택)"),
            React.createElement("input", {
              type: "number",
              value: calories,
        ...
        : React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("span", null, "횟수"),
              React.createElement("span", null, "무게(kg)"),
              React.createElement("span", null)
            ),
            sets.map((s, i) =>
              React.createElement(
                "div",
                { className: "set-row", key: i },
                React.createElement("span", { className: "set-index" }, i + 1),
                React.createElement("input", {
                  type: "number",
                  min: 0,
                  value: s.reps,
                ...
                sets.length > 1
                  ? React.createElement(
                      "button",
                      { type: "button", className: "set-remove", onClick: () => removeSetRow(i) },
                      "✕"
                    )
                  : React.createElement("span", null)
              )
            ...
            React.createElement(
              "button",
              { type: "button", className: "add-set-btn", onClick: addSetRow },
              "+ 세트 추가"
            )
          ),
      React.createElement(
...
export function HistoryView({ profileId }) {
  ...
  const recordListBlock = React.createElement(
    React.Fragment,
    { key: "records" },
    React.createElement("h2", null, selectedDate ? `${selectedDate} 기록` : "전체 기록"),
    selectedDate &&
      React.createElement(
        "div",
        { className: "cal-filter-note" },
        React.createElement("span", null, "달력에서 날짜를 선택해 그날 기록만 볼 수 있어요."),
        React.createElement(
          "button",
          { type: "button", onClick: () => setSelectedDate(null) },
          "전체보기"
        )
      ),
    React.createElement(
      ...
      shownLogs.length === 0 &&
        React.createElement(
          "p",
          { className: "muted" },
          selectedDate ? "이 날짜엔 기록이 없어요." : "아직 기록이 없어요. '운동' 탭에서 첫 기록을 남겨보세요."
        ),
      shownLogs.map((l) =>
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              l.type === "cardio"
                ...
                : `${(l.sets || []).map((s) => `${s.weight}kg×${s.reps}`).join(", ")} (볼륨 ${l.volume.toLocaleString()})`
            )
          ),
          React.createElement(
            "div",
  ...
  const chartsBlock = React.createElement(
    React.Fragment,
    { key: "charts" },
    React.createElement(
      "div",
      ...
      React.createElement(
        "button",
        { type: "button", className: "cal-nav-btn", onClick: prevWeek, "aria-label": "이전 주" },
        "‹"
      ),
      React.createElement("span", { className: "week-nav-label" }, weekLabel),
      React.createElement(
        "button",
        {
          type: "button",
    ...
    React.createElement("h2", null, "일일 총 볼륨"),
    React.createElement(LineChart, { points: dailyVolume, valueSuffix: "kg" }),
    React.createElement("h2", null, "일일 섭취 칼로리"),
    React.createElement(LineChart, { points: dailyKcal, valueSuffix: "kcal", colorVar: "var(--accent-2)" })
  );
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { className: "stat-tile" },
        React.createElement("span", { className: "stat-label" }, "오늘 총 볼륨"),
        React.createElement("span", { className: "stat-value" }, todayVolume.toLocaleString(), React.createElement("em", null, " kg"))
      ),
      React.createElement(
        "div",
        { className: "stat-tile" },
        React.createElement("span", { className: "stat-label" }, "총 기록 수"),
        React.createElement("span", { className: "stat-value" }, logs.length, React.createElement("em", null, " 건"))
      )
    ),
    React.createElement("h2", null, "달력"),
    ...
    selectedDate ? [recordListBlock, chartsBlock] : [chartsBlock, recordListBlock],
