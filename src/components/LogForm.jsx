...
export function LogForm({ exercise, profileId, onClose }) {
  ...
  return React.createElement(
    "div",
    { className: "log-form-view" },
    React.createElement(
      "button",
      { className: "back-btn", onClick: onClose },
      "← 목록으로"
    ),
    React.createElement("h2", null, exercise.name),
    React.createElement(
      "p",
      { className: "muted" },
    ...
    React.createElement(
      "form",
      { className: "log-entry-form", onSubmit: handleSave },
      ...
      isCardio
        ...
        : React.createElement(
            "div",
            { className: "sets-editor" },
            isAssistable &&
              React.createElement(
                "label",
                { style: { display: "flex", alignItems: "center", gap: 6, margin: "4px 0 10px", fontWeight: "normal" } },
                React.createElement("input", {
                  type: "checkbox",
                  checked: assisted,
                  onChange: (e) => setAssisted(e.target.checked),
                }),
                "어시스트 머신으로 했어요 (무게란에 어시스트 무게 입력)"
              ),
            isAssistable &&
              assisted &&
              React.createElement(
                "p",
                { className: "muted", style: { fontSize: "12px", marginBottom: 8 } },
            ...
            React.createElement(
              ...
              React.createElement("span", null, "세트"),
              React.createElement("span", null, "횟수"),
              React.createElement("span", null, isAssistable && assisted ? "어시스트 무게 (kg)" : "무게 (kg)")
            ),
            sets.map((s, i) =>
              React.createElement(
                "div",
                ...
                React.createElement(
                  ...
                  isAssistable &&
                    ...
                    React.createElement(
                      "span",
                      { className: "muted", style: { fontSize: "12px", whiteSpace: "nowrap" } },
                      `→${Math.max(0, Math.round((bodyweightForDate - Number(s.weight)) * 10) / 10)}kg`
                    )
                ),
                sets.length > 1 &&
                  React.createElement(
    ...
    React.createElement("h3", null, "기록 히스토리"),
    React.createElement(
      "div",
      { className: "history-list" },
      logsForThis.length === 0 &&
        React.createElement("p", { className: "muted" }, "아직 기록이 없어요."),
      logsForThis.map((l) =>
        React.createElement(
          "div",
          ...
          React.createElement(
            "button",
            { className: "history-delete", onClick: () => deleteLog(l.id) },
            "삭제"
          )
        )
      )
