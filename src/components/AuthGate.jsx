...
export function AuthGate() {
  ...
  return React.createElement(
    ...
    React.createElement(
      "p",
      { className: "muted" },
      mode === "signup" ? "이름/전화번호/비밀번호로 가입해주세요. 가입 후 마스터의 승인이 필요해요." : "이름과 비밀번호로 로그인해주세요."
    ),
    React.createElement(
      "form",
      { className: "profile-new-form", onSubmit: handleSubmit },
      React.createElement("label", null, "이름 (아이디로 사용돼요)"),
      ...
      mode === "signup" &&
        React.createElement(
          React.Fragment,
          null,
          React.createElement("label", null, "전화번호 (승인 확인용)"),
          React.createElement("input", {
            type: "tel",
      ...
      error && React.createElement("p", { style: { color: "var(--danger)", fontSize: "13px" } }, error),
      React.createElement(
        "button",
        { type: "submit", className: "btn-primary", disabled: busy || !name.trim() || !password },
